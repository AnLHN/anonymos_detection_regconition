...
def main() -> None:
    ...
    for index, result in enumerate(results, start=1):
        ...
        print("- landmarks:", 0 if not face.landmarks else len(face.landmarks))
        print("- recognition_eligible:", result.recognition_eligible)
        print("- quality_score:", round(result.quality_score, 6))
        print("- pose_score:", round(result.pose_score, 6))
